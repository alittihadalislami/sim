                  ...
                  <div class="col-md-12">
					...
					foreach ($response_data as $value) {
						...
						if ( $data_foto == $santri['idk_mii'] ) {
                            $google_drive_id = $value->id_file;
                            $profil = "https://drive.google.com/thumbnail?id=".$google_drive_id;
                            $link_ft = "https://drive.usercontent.google.com/download?id=".$google_drive_id;
                            $target = "_blank";
                        }
					}
				?>
                    <a href="<?=$link_ft?>" target="<?=$target?>" >
