                ...
                <div class="box-body no-padding table-responsive">
                  ...
                  <table class="table table-striped">
                    <tbody><tr>
                      ...
                      <th style="width: 30%">Menu | Submenu</th>
                      <th>Rule</th>
                    </tr>
                      ...
                      <tr>
                        ...
                        <?php foreach ($user_rule as $ur): ?>
                            ...
                            <span class="cek-input" data-menu="<?= $m->id_menu?>" data-rule="<?=$ur->id_rule?>" data-kategori="2">
                              <input class="cek-input" type="checkbox" <?= $akses == 1 ? 'checked' : null ?> data-toggle="toggle"  data-size="xs" data-on="<?= $ur->id_rule.'. '.$ur->nama_rule ?>" data-off="<?= $ur->nama_rule ?>" data-onstyle="success" data-offstyle="secondary">
                            </span>
                        <?php endforeach ?>
                          </td>
                      </tr>
