...
class Raport_model extends CI_Model {
	...
	// semua copy belum jalan hanya catatan saja
	function copyKD(){ 
		$stringQ = " INSERT INTO t_kd (kelas_id, rombel, mapel_id, tahun_id, kdp, kdk, urut, kkm)
	...
	function copyNH(){
		$stringQ = " INSERT INTO t_nh (mapel_id, kelas_id, santri_id, tahun_id, urut_kd, nilai_kdp, nilai_kdk, nilai_suluk)
	...
	function copyNA(){
		$stringQ = " INSERT INTO t_na (kelas_id, mapel_id, tahun_id, santri_id, nkh, nhr, pts, pas, nrp)
